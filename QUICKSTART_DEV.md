# Emare Tedarik — Hızlı Başlangıç (Developer Guide)
...
```bash
# Repo'ya gir
cd /Users/emre/Desktop/Emare/emaretedarik
...
| 6 | `emaretedarik_HAFIZA.md` | Proje geçmişi |
...
- **Derviş**: EmareAPI'de `emaretedarik Dervishi` bu projeden sorumlu
