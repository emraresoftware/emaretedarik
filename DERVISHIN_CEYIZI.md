...
```python
# Emare Tedarik — Yetki Tanımları
PROJE_PERMISSIONS = [
    # Temel
    'emaretedarik.view',      # Görüntüleme
    'emaretedarik.create',    # Oluşturma
    'emaretedarik.edit',      # Düzenleme
    'emaretedarik.delete',    # Silme
    'emaretedarik.manage',    # Tam yönetim
    # Admin
    'emaretedarik.admin',     # Admin panele erişim
    'emaretedarik.users',     # Kullanıcı yönetimi
    'emaretedarik.settings',  # Ayar yönetimi
]
```
...
```python
# emaretedarik/auth/rbac.py — Kopyala, uyarla, kullan.
...
PERMISSIONS = {
    'super_admin': {'*'},
    'admin': {
        'emaretedarik.view', 'emaretedarik.create',
        'emaretedarik.edit', 'emaretedarik.delete',
        'emaretedarik.manage', 'emaretedarik.users',
        'emaretedarik.settings', 'emaretedarik.admin',
    },
    'operator': {
        'emaretedarik.view', 'emaretedarik.create',
        'emaretedarik.edit',
...
| Proje Admini | admin@emaretedarik.emare.dev | admin | Proje yöneticisi |
| API Servisi | api@emaretedarik.emare.dev | super_admin | Machine-to-machine |
